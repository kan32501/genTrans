import sys
# sys.path.append('core') # this line messes up the imports somehow
import argparse
import os
import cv2
import math
...
def main():
    ...
    parser.add_argument('--cfg', help='experiment configure file name', required=True, type=str,
                        default='config/eval/spring-M.json') # the config file name
    parser.add_argument('--path', help='checkpoint path', type=str, 
                        default='models/Tartan-C-T-TSKH-kitti432x960-M.pth') # the model path
    parser.add_argument('--url', help='checkpoint url', type=str, 
                        default=None) # OR the model url 
