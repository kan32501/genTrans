...
def plot_color_line_matches(lines, correct_matches=None,
    ...
    """
    n_lines = len(lines[0])
    colors = sns.color_palette(n_colors=n_lines)
...
def plot_color_line_matches_opencv(image, lines, save_path='./', correct_matches=None, lw=2, black=True, number=False):
    ...
    for l in lines:
        ...
        for i in range(n_lines):
            ...
            # remove below line for cv2.puttext
            ...
            if number:
                ...
                cv2.putText(image, 
                            ...
                            fontFace = cv2.FONT_HERSHEY_DUPLEX, fontScale = 0.5, color = color, thickness = 1)
